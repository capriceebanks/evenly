// Step #: Page to show event details
...
const EventDetails = async ({ params: { id }, searchParams }: SearchParamProps) => {
	...
	return (
		<>
		<section className="flex sm:flex-col justify-center bg-primary-50 bg-dotted-pattern bg-contain">
					...
					<div className="flex flex-col gap-5">
						<div className="flex gap-2 md:gap-3">
							<Image
								...
								height={32}
							/>
							<div className="p-medium-16 lg:p-medium-20 flex flex-wrap items-center">
								<p>
          ...
          <div className='flex flex-col gap-2'>
            ...
            <p className='p-medium-16 lg:p-medium-18 truncate text-primary-500 underline'>{event.url}</p>
          </div>
				</div>
			</div>
		</section>
